// OSFG Simple Demo - No Frame Generation
// Just capture and display to verify the pipeline works
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    std::cout << "=== OSFG Simple Demo (No Frame Generation) ===\n";
    ...
    presConfig.windowTitle = L"OSFG Simple Demo";
